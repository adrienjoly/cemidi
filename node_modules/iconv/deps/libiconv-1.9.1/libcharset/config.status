...
configured by ./configure, generated by GNU Autoconf 2.57,
  with options \"'--prefix=/usr/local' '--disable-shared' '--enable-static' '--enable-relocatable' '--enable-extra-encodings' '--cache-file=/dev/null' '--srcdir=.'\"
...
if $ac_cs_recheck; then
  echo "running /bin/sh ./configure " '--prefix=/usr/local' '--disable-shared' '--enable-static' '--enable-relocatable' '--enable-extra-encodings' '--cache-file=/dev/null' '--srcdir=.' $ac_configure_extra_args " --no-create --no-recursion" >&6
  exec /bin/sh ./configure '--prefix=/usr/local' '--disable-shared' '--enable-static' '--enable-relocatable' '--enable-extra-encodings' '--cache-file=/dev/null' '--srcdir=.' $ac_configure_extra_args --no-create --no-recursion
fi
