...
echo >&5
config_files=" Makefile lib/Makefile srclib/Makefile src/Makefile po/Makefile.in man/Makefile tests/Makefile include/iconv.h"
config_headers=" config.h lib/config.h"
config_commands=" depfiles default-1"
...
configured by ./configure, generated by GNU Autoconf 2.57,
  with options \"'--disable-shared' '--enable-static' '--enable-relocatable' '--enable-extra-encodings'\"
...
if $ac_cs_recheck; then
  echo "running /bin/sh ./configure " '--disable-shared' '--enable-static' '--enable-relocatable' '--enable-extra-encodings' $ac_configure_extra_args " --no-create --no-recursion" >&6
  exec /bin/sh ./configure '--disable-shared' '--enable-static' '--enable-relocatable' '--enable-extra-encodings' $ac_configure_extra_args --no-create --no-recursion
fi
...
s,@ECHO_T@,,;t t
s,@LIBS@,,;t t
s,@INSTALL_PROGRAM@,$(top_builddir)/autoconf/install-reloc,;t t
s,@INSTALL_SCRIPT@,${INSTALL},;t t
s,@INSTALL_DATA@,${INSTALL} -m 644,;t t
s,@CYGPATH_W@,echo,;t t
s,@PACKAGE@,libiconv,;t t
s,@VERSION@,1.9,;t t
s,@ACLOCAL@,${SHELL} /Users/adrienjoly/Dev/whyd/whydJS/node_modules/iconv-jp/deps/libiconv-1.9.1/autoconf/missing --run aclocal-1.7,;t t
s,@AUTOCONF@,${SHELL} /Users/adrienjoly/Dev/whyd/whydJS/node_modules/iconv-jp/deps/libiconv-1.9.1/autoconf/missing --run autoconf,;t t
s,@AUTOMAKE@,${SHELL} /Users/adrienjoly/Dev/whyd/whydJS/node_modules/iconv-jp/deps/libiconv-1.9.1/autoconf/missing --run automake-1.7,;t t
s,@AUTOHEADER@,${SHELL} /Users/adrienjoly/Dev/whyd/whydJS/node_modules/iconv-jp/deps/libiconv-1.9.1/autoconf/missing --run autoheader,;t t
s,@MAKEINFO@,${SHELL} /Users/adrienjoly/Dev/whyd/whydJS/node_modules/iconv-jp/deps/libiconv-1.9.1/autoconf/missing --run makeinfo,;t t
s,@AMTAR@,${SHELL} /Users/adrienjoly/Dev/whyd/whydJS/node_modules/iconv-jp/deps/libiconv-1.9.1/autoconf/missing --run tar,;t t
s,@install_sh@,/Users/adrienjoly/Dev/whyd/whydJS/node_modules/iconv-jp/deps/libiconv-1.9.1/autoconf/install-sh,;t t
s,@STRIP@,strip,;t t
...
s,@CPP@,gcc -E,;t t
s,@EGREP@,grep -E,;t t
s,@build@,i686-apple-darwin10.8.0,;t t
s,@build_cpu@,i686,;t t
s,@build_vendor@,apple,;t t
s,@build_os@,darwin10.8.0,;t t
s,@host@,i686-apple-darwin10.8.0,;t t
s,@host_cpu@,i686,;t t
s,@host_vendor@,apple,;t t
s,@host_os@,darwin10.8.0,;t t
s,@RELOCATABLE@,yes,;t t
s,@LIBOBJS@, relocatable$U.o canonicalize$U.o,;t t
s,@SET_RELOCATABLE@,INSTALL_PROGRAM_ENV = RELOC_LIBRARY_PATH_VAR="DYLD_LIBRARY_PATH" RELOC_LIBRARY_PATH_VALUE="$(RELOCATABLE_LIBRARY_PATH)" RELOC_PREFIX="$(prefix)" RELOC_COMPILE_COMMAND="$(CC) $(CPPFLAGS) $(CFLAGS) $(LDFLAGS)" RELOC_SRCDIR="$(RELOCATABLE_SRC_DIR)" RELOC_BUILDDIR="$(RELOCATABLE_BUILD_DIR)" RELOC_CONFIG_H_DIR="$(RELOCATABLE_CONFIG_H_DIR)" RELOC_INSTALL_PROG="${INSTALL}",;t t
...
s,@MKINSTALLDIRS@,$(top_builddir)/autoconf/mkinstalldirs,;t t
s,@USE_NLS@,no,;t t
s,@MSGFMT@,/opt/local/bin/msgfmt,;t t
s,@GMSGFMT@,/opt/local/bin/msgfmt,;t t
s,@XGETTEXT@,/opt/local/bin/xgettext,;t t
s,@MSGMERGE@,/opt/local/bin/msgmerge,;t t
s,@INTLLIBS@,,;t t
s,@LIBINTL@,,;t t
s,@LTLIBINTL@,,;t t
s,@POSUB@,,;t t
...
s,@LTLIBOBJS@, relocatable$U.lo canonicalize$U.lo,;t t
CEOF
...
${ac_dA}PACKAGE${ac_dB}PACKAGE${ac_dC}"libiconv"${ac_dD}
${ac_dA}VERSION${ac_dB}VERSION${ac_dC}"1.9"${ac_dD}
${ac_dA}INSTALLPREFIX${ac_dB}INSTALLPREFIX${ac_dC}"/usr/local"${ac_dD}
${ac_dA}ENABLE_RELOCATABLE${ac_dB}ENABLE_RELOCATABLE${ac_dC}1${ac_dD}
${ac_dA}ENABLE_EXTRA${ac_dB}ENABLE_EXTRA${ac_dC}1${ac_dD}
...
${ac_dA}HAVE_WCRTOMB${ac_dB}HAVE_WCRTOMB${ac_dC}1${ac_dD}
...
${ac_dA}WORDS_LITTLEENDIAN${ac_dB}WORDS_LITTLEENDIAN${ac_dC}1${ac_dD}
...
${ac_dA}HAVE_UNISTD_H${ac_dB}HAVE_UNISTD_H${ac_dC}1${ac_dD}
${ac_dA}realpath${ac_dB}realpath${ac_dC}rpl_realpath${ac_dD}
...
${ac_dA}HAVE_DECL_FGETS_UNLOCKED${ac_dB}HAVE_DECL_FGETS_UNLOCKED${ac_dC}0${ac_dD}
${ac_dA}HAVE_DECL_FPUTC_UNLOCKED${ac_dB}HAVE_DECL_FPUTC_UNLOCKED${ac_dC}0${ac_dD}
${ac_dA}HAVE_DECL_FPUTS_UNLOCKED${ac_dB}HAVE_DECL_FPUTS_UNLOCKED${ac_dC}0${ac_dD}
...
${ac_dA}HAVE_SEARCH_H${ac_dB}HAVE_SEARCH_H${ac_dC}1${ac_dD}
${ac_dA}HAVE_STDLIB_H${ac_dB}HAVE_STDLIB_H${ac_dC}1${ac_dD}
${ac_dA}HAVE_STRING_H${ac_dB}HAVE_STRING_H${ac_dC}1${ac_dD}
${ac_dA}HAVE_UNISTD_H${ac_dB}HAVE_UNISTD_H${ac_dC}1${ac_dD}
...
${ac_uA}PACKAGE${ac_uB}PACKAGE${ac_uC}"libiconv"${ac_uD}
${ac_uA}VERSION${ac_uB}VERSION${ac_uC}"1.9"${ac_uD}
${ac_uA}INSTALLPREFIX${ac_uB}INSTALLPREFIX${ac_uC}"/usr/local"${ac_uD}
${ac_uA}ENABLE_RELOCATABLE${ac_uB}ENABLE_RELOCATABLE${ac_uC}1${ac_uD}
${ac_uA}ENABLE_EXTRA${ac_uB}ENABLE_EXTRA${ac_uC}1${ac_uD}
...
${ac_uA}HAVE_WCRTOMB${ac_uB}HAVE_WCRTOMB${ac_uC}1${ac_uD}
...
${ac_uA}WORDS_LITTLEENDIAN${ac_uB}WORDS_LITTLEENDIAN${ac_uC}1${ac_uD}
...
${ac_uA}HAVE_UNISTD_H${ac_uB}HAVE_UNISTD_H${ac_uC}1${ac_uD}
${ac_uA}realpath${ac_uB}realpath${ac_uC}rpl_realpath${ac_uD}
...
${ac_uA}HAVE_DECL_FGETS_UNLOCKED${ac_uB}HAVE_DECL_FGETS_UNLOCKED${ac_uC}0${ac_uD}
${ac_uA}HAVE_DECL_FPUTC_UNLOCKED${ac_uB}HAVE_DECL_FPUTC_UNLOCKED${ac_uC}0${ac_uD}
${ac_uA}HAVE_DECL_FPUTS_UNLOCKED${ac_uB}HAVE_DECL_FPUTS_UNLOCKED${ac_uC}0${ac_uD}
...
${ac_uA}HAVE_SEARCH_H${ac_uB}HAVE_SEARCH_H${ac_uC}1${ac_uD}
${ac_uA}HAVE_STDLIB_H${ac_uB}HAVE_STDLIB_H${ac_uC}1${ac_uD}
${ac_uA}HAVE_STRING_H${ac_uB}HAVE_STRING_H${ac_uC}1${ac_uD}
${ac_uA}HAVE_UNISTD_H${ac_uB}HAVE_UNISTD_H${ac_uC}1${ac_uD}
